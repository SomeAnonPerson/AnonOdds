                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(logic.gateways[logic.selectedIndex.value].accountDetais ?? "",style: MyStyles.getTextTheme(isLightTheme: MyTheme().getThemeIsLight).bodyMedium,),
                            ],
                          ),
                        ),
                      )),
                                  ...
                                  child: GestureDetector(
                                    ...
                                    child: DottedBorderWidget(
                                      ...
                                      children: [
                                        ...
                                        const SizedBox(height: 10.0,),
                                        Text("Upload Receipt Image",style: MyStyles.getTextTheme(isLightTheme: MyTheme().getThemeIsLight).bodyMedium,),
                                      ],
                                    )),
                                  ),
                                ),
