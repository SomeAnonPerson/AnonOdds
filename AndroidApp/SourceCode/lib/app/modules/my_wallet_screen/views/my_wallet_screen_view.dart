                          ...
                          itemBuilder: (_,i){
                            return Container(
                              ...
                              child: ListTile(
                                ...
                                title: Text(logic.transactionLogModel.trans?.data?[i].description ?? "",style: MyStyles.getTextTheme(isLightTheme: MyTheme().getThemeIsLight).bodyLarge,),
                                subtitle: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Text('T. ID: ${logic.transactionLogModel.trans?.data?[i].trx}',style: MyStyles.getTextTheme(isLightTheme: MyTheme().getThemeIsLight).bodySmall,),
                                    Text(DateTimeFormat.format(DateTime.parse(logic.transactionLogModel.trans?.data?[i].createdAt ?? ''), format: AmericanDateFormats.dayOfWeek),style: MyStyles.getTextTheme(isLightTheme: MyTheme().getThemeIsLight).bodySmall,),
                                  ],
                                ),
                                trailing: Text('\$${logic.transactionLogModel.trans?.data?[i].amount}',style: MyStyles.getTextTheme(isLightTheme: MyTheme().getThemeIsLight).bodyMedium!.copyWith(color: MyStyles.getPrimaryColor(isLightTheme: MyTheme().getThemeIsLight)),),
                              ),
                            );
                          })
                    ],
